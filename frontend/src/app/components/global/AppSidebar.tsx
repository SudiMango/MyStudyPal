...
const AppSidebar = () => {
    ...
    return (
        <>
            <div className="md:hidden sticky top-0 z-30 bg-(--discord-gray-4) border-b border-(--discord-gray-3)">
                <div className="flex flex-row items-center h-15 p-2">
                    <Link
                        className="inline-flex flex-row w-auto text-xl text-(--discord-blurple) font-bold py-2 px-1 justify-center items-center"
                        href="/app/study-sets"
                    >
                    ...
                    <button
                        ...
                        className="ml-auto rounded-md bg-(--discord-gray-2) hover:bg-(--discord-gray-1) cursor-pointer p-2"
                    >
            ...
            {isMobileMenuOpen && (
                <div className="fixed inset-0 z-50 bg-(--discord-gray-4) md:hidden flex flex-col">
                    <div className="flex flex-row items-center h-15 p-2 border-b border-(--discord-gray-3)">
                        <Link
                            className="inline-flex flex-row w-auto text-xl text-(--discord-blurple) font-bold py-2 px-1 justify-center items-center"
                            href="/app/study-sets"
                    ...
                    <div className="mt-auto p-3 border-t border-(--discord-gray-3)">
                        <div className="flex flex-row items-center w-full p-3 rounded-xl bg-(--discord-gray-3) mb-3">
                        ...
                        <button
                            ...
                            className="flex flex-row items-center space-x-3 w-full px-4 py-3 rounded-lg hover:bg-(--discord-gray-3) transition-colors"
                        >
                        ...
                        <button
                            ...
                            className="flex flex-row items-center space-x-3 w-full px-4 py-3 rounded-lg hover:bg-(--discord-gray-3) transition-colors text-red-400"
                        >
