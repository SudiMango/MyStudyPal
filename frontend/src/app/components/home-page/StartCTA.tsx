...
const StartCTA = () => {
    return (
        <div className="flex flex-col justify-center items-center w-full max-w-200 mb-10 px-5 max-[850px]:px-5 min-[850px]:px-0">
            <div className="flex flex-col justify-center items-center w-full bg-(--discord-blurple)/20 rounded-xl shadow-2xl p-5 space-y-2">
                ...
                <label className="opacity-60 text-center">
                    Join 1,000+ students crushing their exams. Start studying
                    faster for free.
                </label>
                <Link
                    href="/signup"
