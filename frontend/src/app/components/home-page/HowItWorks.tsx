...
const HowItWorks = () => {
    return (
        <div className="flex flex-col justify-center items-center w-full max-w-[800px] mb-10 px-5 [@media(min-width:850px)]:px-0">
            ...
            <div className="flex flex-col space-y-5 w-full">
                <div className="flex flex-col sm:flex-row space-y-5 sm:space-x-5 w-full">
                    <div className="bg-(--discord-gray-4) p-3 w-full h-full min-h-[250px] rounded-lg shadow-lg flex flex-col">
                        <label className="text-lg">
                            1. Upload your notes to a set
                        </label>
                        <div className="w-full h-full flex flex-1 items-center justify-center">
                            <Image
                                src="/university-logos/ubc"
                                alt="smth"
                                width={100}
                                height={80}
